...
import { PopularPeopleListResponse } from '../models/popular-people-list.interface';
...
export class HomeService {
  ...
  getPeopleList(): Observable<PopularPeopleListResponse>{
    return this.http.get<PopularPeopleListResponse>(`${API_BASE_URL}/person/popular?&language=es-ES`, HEADERS);
  }
