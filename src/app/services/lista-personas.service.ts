...
import { detalle, ListaPersonas, Personas } from '../models/lista-personas.interfaces';
...
getDetalleId(id: number): Observable<detalle> {
    return this.http.get<detalle>(`https://api.themoviedb.org/3/person/${id}?&language=es-ES`, {
      headers: {
        Authorization: `Bearer ${'eyJhbGciOiJIUzI1NiJ9.eyJhdWQiOiJjZDA1NzdlOGNkMmUyYjU0OWY5NDYxOTU0NTBmZDQ5YiIsIm5iZiI6MTczMTg2NTU0OS45MDU4MzA0LCJzdWIiOiI2NzMxYmYzNjdlZjJjMzFkNzhlZGFjNGEiLCJzY29wZXMiOlsiYXBpX3JlYWQiXSwidmVyc2lvbiI6MX0.EDrGv4SuXDqQRkvgTCjqk3GVvAA0zIMTf7CRDK5863w'}`,
      },
    });
  ...
  getpersonasId(id: number): Observable<Personas> {
    return this.http.get<Personas>(`https://api.themoviedb.org/3/person/${id}?&language=es-ES`, {
      headers: {
        Authorization: `Bearer ${'eyJhbGciOiJIUzI1NiJ9.eyJhdWQiOiJjZDA1NzdlOGNkMmUyYjU0OWY5NDYxOTU0NTBmZDQ5YiIsIm5iZiI6MTczMTg2NTU0OS45MDU4MzA0LCJzdWIiOiI2NzMxYmYzNjdlZjJjMzFkNzhlZGFjNGEiLCJzY29wZXMiOlsiYXBpX3JlYWQiXSwidmVyc2lvbiI6MX0.EDrGv4SuXDqQRkvgTCjqk3GVvAA0zIMTf7CRDK5863w'}`,},
    });
  }
